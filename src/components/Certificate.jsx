...
const Certificate = React.forwardRef(({ result, examConfig }, ref) => {
  ...
  return (
    <div ref={ref} className="certificate-print">
      ...
      {/* Outer border with modern pattern */}
      <div
        style={{
          position: "absolute",
          inset: "8mm",
          border: isPassed ? "4px solid #10b981" : "4px solid #94a3b8",
          borderRadius: "8px",
          background: "linear-gradient(45deg, transparent 45%, #f1f5f9 50%, transparent 55%)",
      ...
      {/* Decorative corners */}
      <div style={{ position: "absolute", top: "12mm", left: "12mm", width: "40mm", height: "40mm", borderTop: `8mm solid ${isPassed ? '#10b981' : '#94a3b8'}`, borderLeft: `8mm solid ${isPassed ? '#10b981' : '#94a3b8'}`, opacity: 0.1 }} />
      <div style={{ position: "absolute", bottom: "12mm", right: "12mm", width: "40mm", height: "40mm", borderBottom: `8mm solid ${isPassed ? '#10b981' : '#94a3b8'}`, borderRight: `8mm solid ${isPassed ? '#10b981' : '#94a3b8'}`, opacity: 0.1 }} />
