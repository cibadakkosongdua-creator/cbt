        ...
        <div className="flex h-14 items-center justify-between gap-3">
          ...
          <div className="tour-tools flex items-center gap-2">
            ...
            <button
              ...
              className={`hidden sm:flex h-8 w-8 items-center justify-center rounded-xl transition ${
                showReadingRuler ? "bg-indigo-100 text-indigo-600" : "text-slate-400 hover:bg-slate-100 hover:text-slate-600"
              }`}
              title="Garis Bantu Baca"
            >
              <i className="fas fa-grip-lines text-sm" />
            </button>
            ...
            <button
              ...
              className={`hidden sm:flex h-8 w-8 items-center justify-center rounded-xl transition ${
                isDyslexic ? "bg-violet-100 text-violet-600 font-bold" : "text-slate-400 hover:bg-slate-100 hover:text-slate-600"
              }`}
              title="Font Khusus Disleksia"
            >
              <span className="text-[10px] font-black">abc</span>
            </button>
