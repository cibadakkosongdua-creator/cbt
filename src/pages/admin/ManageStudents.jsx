                  ...
                  (() => {
                    ...
                    return paginatedData.map((s, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-xs text-slate-500" title={`${s.tempat_lahir}, ${s.tanggal_lahir}`}>
                          <div className="flex flex-col gap-0.5">
                            <span className="font-medium text-slate-700 truncate max-w-[120px]">{s.tempat_lahir || "–"}</span>
                            <span className="text-slate-400">{s.tanggal_lahir || "–"}</span>
                          </div>
                        </td>
